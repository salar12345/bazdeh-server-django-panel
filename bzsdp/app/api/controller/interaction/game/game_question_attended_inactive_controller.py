...
class GameQuestionAttendedInActiveController(BaseGameQuestionController, APIView, metaclass=Singleton):
    ...
    def get(self, request: Request) -> Response:
        try:
            ...
            if self.member_logic.check_if_user_is_logged_in(member):
                questions = self.game_question_logic.get_all_member_attended_inactive_questions(member)
                data = self.enrich_list_question_data(questions, member)
