...
class NewsAnalysisDoLikeController(BasePanelController, APIView, metaclass=Singleton):
    def __init__(self):
        super().__init__()
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            try:
                self.logic.do_like(news_analysis_id=news_analysis_id, member=member, state=state, news_or_analysis=news_or_analysis)
