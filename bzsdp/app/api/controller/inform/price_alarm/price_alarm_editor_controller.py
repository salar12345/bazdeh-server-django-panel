...
from bzsdp.app.api.serializer.inform.alarm.edith_price_alarm_serializer import EdithPriceAlarmSerializer
...
class PriceAlarmEditorController(BasePanelController, APIView, metaclass=Singleton):
    def __init__(self):
        super().__init__()
    ...
    def post(self, request):
        data = request.data
        serializer = EdithPriceAlarmSerializer(data=data)
        if serializer.is_valid():
            ...
            self.logic.edith_price_alarm(alarm_id=alarm_id, alarm_price=alarm_price, now_price=now_price, name=name,
